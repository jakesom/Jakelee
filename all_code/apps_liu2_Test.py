...
def inference(weights_path, img_path, crop_size, overlap_size, savejson_func, json_output_dir, postfix,
    ...
    elif weights_path == 'weights/airplane-4-23.pt':
        names = {0: 'bomber', 1: 'transport_plane', 2: 'warplane', 3: 'attack_plane', 4: 'early_warning_airplane', 5: 'oil_plane', 6: 'antisubmarine_plane'}
    ...
    for i, x in enumerate(x_steps):
        for j, y in enumerate(y_steps):
            ...
            if len(result[0].boxes.data) > 0:
                ...
                if weights_path == 'weights/airplane-4-23.pt' or weights_path == 'weights/harbor.pt':
                    # 遍历检测框
...
def class_begin():
    ...
    big_img_path = r"C:\Users\Administrator\Desktop\SpaceNet\SpaceNet_3.jpg"
    img_path_Airport = Airport_ROI_Pic  # 机场裁剪图地址
    # img_path_Airport = r"D:\E\Python\flask_all\flask\harborpic1.jpg"
    img_path_port = r"D:\E\Python\flask_all\flask\harborpic1.jpg"
    Port_Pos = [12192,10000]
    ...
    #         if img_path_Airport:
    #             image_name = 'Airplane'
    #             weights_path = r'weights/airplane-4-23.pt'
    #             conf_score = 0.42
    ...
    #画出最终合并的大图
    '----画出大图并保存----'
    # big_img_with_boxes,big_w,big_h = draw_longitude('combinate_pic.tif', ori_path, big_pic_paste)
    # detect_imge = {
    #     "ori_detect": image_to_base64(big_img_with_boxes),
    #     "image_name": "large_pic",
    #     "large_size": (big_w,big_h)
    # }
