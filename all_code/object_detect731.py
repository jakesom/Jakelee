...
def inference(weights_path, img_path, crop_size, overlap_size, savejson_func, json_output_dir, postfix,
    ...
    # 改舰船的标签名字
    if weights_path == 'weights/ship729.pt':
    ...
    for i, x in enumerate(x_steps):
        for j, y in enumerate(y_steps):
            ...
            #旋转框
            elif weights_path == 'weights/ship729.pt' or weights_path == 'weights/airplane729.pt':
    ...
    if combined_results:
        ...
        # 提取分数
        if weights_path == 'weights/ship729.pt' or weights_path == 'weights/airplane729.pt':
...
def class_begin():
    ...
    if img_path_Port:
        # 检测 舰船
        Use_Mask = False
        weights_path = r'weights/ship729.pt'
        image_name = 'ship'
