...
def cut_roi_from_large_pic(save_category=None, pred_label_save_txt_post_processing=None, pic_name=None, patch_size=None,
...
def scene_classification(pic_name=None, num_rows=None):
    PIL_img_dict = {}
    ...
    large_image = Image.open(os.path.join(current_dir, pic_name + ".tif"))
    ...
    if pic_name == 'qq':
        ...
        PIL_img_dict["original_Pic"] = [image_to_base64(image)]
        PIL_img_dict["Airport_ROI_Pic"] = [image_to_base64(cropped_image)]
        PIL_img_dict["Airport_Pos"] = [x1, y1, x2, y2]
        PIL_img_dict["Port"] = []
        print("保存图像完成！")
        ...
        PIL_img_dict["Airport_Pic"] = [image_to_base64(image)]
        PIL_img_dict["Airport_ROI_Pic"] = [image_to_base64(cropped_image)]
        PIL_img_dict["Airport_Pos"] = [x1, y1, x2, y2]
        print("保存图像完成！")
        # print()
        ...
        PIL_img_dict["Port_Pic"] = [image_to_base64(image)]
        PIL_img_dict["Port_ROI_Pic"] = [image_to_base64(cropped_image)]
        PIL_img_dict["Port_Pos"] = [x1, y1, x2, y2]
        print("保存图像完成！")
...
def class_begin():
    ...
    # image_path = request.args.get("num_rows")
    # pic_name = "zy"
