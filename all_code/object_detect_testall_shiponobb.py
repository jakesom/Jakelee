...
def inference(weights_path, img_path, crop_size, overlap_size, savejson_func, json_output_dir, postfix,
    ...
    for i, x in enumerate(x_steps):
        for j, y in enumerate(y_steps):
            ...
            #水平框
            if weights_path == 'weights/ship50.pt' or  weights_path == 'weights/harbor.pt' :
                if  len(result[0].boxes.data) > 0:
                    detect_yes = True
    ...
    if weights_path == 'weights/harbor.pt':
        ...
        oiltank_list = [item for item in results if item['cls'] == 'oiltank']
        ...
        results = [item for item in results if item['cls'] != 'oiltank'] + filtered_oiltank_list
